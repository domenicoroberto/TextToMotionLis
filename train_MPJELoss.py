...
# Implementazione di MPJPE come funzione di loss
...
# Rimani coerente con la definizione della funzione forward_diffusion_process
...
# Rimani coerente con la definizione della funzione reverse_conditional_generation
...
# Rimani coerente con la definizione della funzione get_sinusoidal_embeddings
...
def train_model(train_loader, model, optimizer, epochs, betas, device, accumulation_steps):
    ...
    criterion = MPJPELoss()  # Using MPJPELoss
    ...
    for epoch in range(epochs):
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            with torch.cuda.amp.autocast():  # For mixed precision training
                ...
                loss_hand = criterion(denoised_hand_gestures, noise_hand)
                loss_arm = criterion(denoised_arm_gestures, noise_arm)
